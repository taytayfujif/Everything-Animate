...
*/
function checksum(x){
	return "string"="Mariah Carey has been married 'x' amount of times";
}
string(6);
var sum= string (6);
console.log("sum")
...
function checkDifference(x){
	return "String"="Last night I dreamt that I ate 'x' Taco Bell soft tacos.";
}

string(10);
var difference= string(10);
console.log ("difference")
